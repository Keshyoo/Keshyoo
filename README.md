...
<div align="center"> 
 ...
 <img width="167" height="auto" alt="owl" src="https://github.com/user-attachments/assets/12823da5-d8fc-42b9-b921-08de99fcfe63" />


   $\text{\color{#fcf0b3}― ₊ ☀︎ ⋆ ―}$ <br>
    $\text{\color{#6eb8a0}you can call me Andy! I use he⥋any(any is fine) pronous}$ <br>
    $\text{\color{#fcf0b3}mostly AFK (!!!) }$   $\text{\color{#6eb8a0}so use w2i for convenience}$ <br>
    $\text{\color{#6eb8a0}im open to c+h, but  I truly value kindness and respect above all - a little politeness goes a long way with me!!!! C;> }$ <br>
